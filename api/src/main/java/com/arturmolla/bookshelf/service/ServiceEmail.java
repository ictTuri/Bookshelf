...
public class ServiceEmail {
    ...
    @Async
    public void sendEmail(String to, String username, EmailTemplateName emailTemplate, String confirmUrl, String activationCode, String subject) throws MessagingException {
        String templateName;
        ...
        helper.setFrom("mollaartur13@gmail.com");
        helper.setTo(to);
